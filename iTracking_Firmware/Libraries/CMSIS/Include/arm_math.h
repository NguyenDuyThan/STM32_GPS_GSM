...
#define __CLZ __clz
  ...
  typedef struct
  {
    ...
    char postShift;       /**< Additional shift, in bits, applied to each output sample. */
  ...
  typedef struct
  {
    ...
    char   ifftFlag;              /**< flag that selects forward (ifftFlag=0) or inverse (ifftFlag=1) transform. */
    char   bitReverseFlag;        /**< flag that enables (bitReverseFlag=1) or disables (bitReverseFlag=0) bit reversal of output. */
  ...
  typedef struct
  {
    ...
    char  ifftFlagR;                       /**< flag that selects forward (ifftFlagR=0) or inverse (ifftFlagR=1) transform. */
	char  bitReverseFlagR;                 /**< flag that enables (bitReverseFlagR=1) or disables (bitReverseFlagR=0) bit reversal of output. */
 ...
 */
  ...
  typedef struct
  {
    char numStages;       /**< number of 2nd order stages in the filter.  Overall order is 2*numStages. */
 ...
 */
  ...
  typedef struct
  {
    ...
    q31_t *pCoeffs;       /**< points to the coefficient array. The array is of length numTaps. */
    q31_t mu;             /**< step size that controls filter coefficient updates. */
    char postShift;    /**< bit shift applied to coefficients. */
