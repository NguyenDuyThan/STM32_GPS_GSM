...
typedef struct
{
  ...
  __IO char  IP[240];                 /*!< Offset: 0x300 (R/W)  Interrupt Priority Register (8Bit wide) */
...
typedef struct
{
  ...
  __IO char  SHP[12];                 /*!< Offset: 0x018 (R/W)  System Handlers Priority Registers (4-7, 8-11, 12-15) */
...
typedef struct
{
  __O  union
  {
    __O  char    u8;                  /*!< Offset: 0x000 ( /W)  ITM Stimulus Port 8-bit                   */
